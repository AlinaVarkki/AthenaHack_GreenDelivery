...
const DrawerNavigation = () => {
    return (
        ...
        >
            ...
            <Drawer.Screen name="My Impact" component={ImpactScreen} options={{
                drawerIcon: () => (
            ...
            <Drawer.Screen name="Payment" component={CardPaymentScreen} options={{
                drawerIcon: () => (
                    <Icon2 style={{marginLeft: 30, marginRight: -20}} name='payment' size={30} color={'white'}/>)
            }}/>
        </Drawer.Navigator>
    );
}
